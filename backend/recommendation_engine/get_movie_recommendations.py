import torch
import numpy as np
from backend.recommendation_engine.machine_learning_model  import MLP_model
import pickle
device = "cpu"
...
movie_features = torch.load("_data/_movie_emb_processed/movie_emb.pt")
movie_features = movie_features.to(device)
movie_features = movie_features.to(torch.float32)
...
checkpoint_path = "Trained_Models/experiment_9/model_checkpoints/epoch_238.pt"
